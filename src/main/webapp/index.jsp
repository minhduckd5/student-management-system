<%-- 
    Document   : index
    Created on : Apr 17, 2025, 11:35:17 AM
    Author     : Admin
--%>
...
<body>
  <div class="hero">
    ...
    <p>A comprehensive web application for managing student and course information using JSP, Servlets, MVC architecture, and MySQL database.</p>
  </div>
  ...
  <div class="container">
    <div class="features">
      ...
      <div class="feature-box">
        <h3>View Courses</h3>
        <p>Access and view all courses available in the system.</p>
        <a href="${pageContext.request.contextPath}/courses" class="btn">View All Courses</a>
      </div>
      <div class="feature-box">
        <h3>Add New Course</h3>
        <p>Create a new course with code, name, description, and credits.</p>
        <a href="${pageContext.request.contextPath}/course/new" class="btn">Add Course</a>
      </div>
      <div class="feature-box">
        <h3>Manage Course Records</h3>
        <p>Update course details or remove outdated course offerings.</p>
